...
namespace ControlStation
{
    public class HeadingIndicator : Panel
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g.DrawImage(DrawCompass(heading, 0, 1, 0, 1, new Size(300, 300)), 0, 0);
        }
        //from here:
        //https://www.codeproject.com/Articles/788611/A-simple-Compass
        private Bitmap DrawCompass(double degree, double pitch, double maxpitch, double tilt, double maxtilt, Size s)
        {
                                ...
                                using (Pen pen2 = new Pen(Color.FromArgb(255, 255, 255), ((int)(sizeMultiplier) < 1 ? 1 : (int)(sizeMultiplier))))
                                {
                                    ...
                                    using (Graphics g = Graphics.FromImage(result))
                                    {
                                        ...
                                        */
                                        ...
                                        String deg = Math.Round(degree).ToString("000");
                                        ...
                                        g.DrawString(markeddeg, font1, drawBrushBlue, new Point(xcenterpoint - (int)(s4.Width / 2), ycenterpoint + (int)(sizeMultiplier * 40)));
